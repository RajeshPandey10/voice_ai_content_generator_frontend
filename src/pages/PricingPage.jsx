  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-950">
      <div className="container max-w-7xl mx-auto px-4 py-8">
          ...
          {plans.map((plan, index) => (
            <Card
              ...
              className={`relative transition-all duration-300 hover:shadow-xl ${
                plan.popular
                  ? "border-purple-500 shadow-lg scale-105 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-950 dark:to-blue-950"
                  : "bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800"
              }`}
            >
              {plan.popular && (
                <Badge className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-500 to-blue-500 text-white shadow-lg">
              ...
              <CardHeader className="text-center pb-4">
                <div
                  className={`flex items-center justify-center w-12 h-12 rounded-lg mx-auto mb-4 ${
                    plan.popular
                      ? "bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-800 dark:to-blue-800 text-purple-600 dark:text-purple-300"
                  ...
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-4 space-y-3">
                    ...
                    {plan.limitations.map((limitation, limitIndex) => (
                      <div key={limitIndex} className="flex items-start gap-3">
                        <div className="h-4 w-4 rounded-full bg-gray-300 dark:bg-gray-600 mt-0.5 flex-shrink-0" />
        ...
        {/* Features Comparison */}
        <Card className="mb-12 bg-white dark:bg-gray-900 shadow-lg">
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center w-16 h-16 bg-yellow-100 dark:bg-yellow-900 rounded-2xl mx-auto mb-4">
        ...
        {/* Call to Action */}
        <Card className="text-center bg-gradient-to-r from-purple-500 to-blue-500 text-white border-0 mt-12">
